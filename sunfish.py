...
def print_pos(pos):
    """A handy function to print the board in a human-readable format"""
    board = pos.board
    # If it's black's turn, the board is stored rotated. 
    # We rotate it back for printing if necessary, or just print as is.
    print()
    for r in range(2, 10):
        line = ""
        for c in range(1, 9):
...
# minifier-hide start
# Wrap the UCI execution in a "main" guard
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            import tools.uci
            # This only runs if you run `python3 sunfish.py` directly
            # It will NOT run when you do `from sunfish import ...`
            ...
            print("UCI tools not found. Run as library.")
# minifier-hide end
